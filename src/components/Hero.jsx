...
const Hero = () => {
  return (
    <div className='flex items-center justify-center flex-col py-20'>
      ...
      <a href="#"className='inline-block px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-violet-700 md:text-md'>My Projects</a>
    </div>
    </div>
  )
}
